"""Tests for deepseek_toolkit.token_counter — token counting."""
import pytest
...
class TestCountTokens:
    ...
    def test_count_text_returns_int(self):
        from deepseek_toolkit.token_counter import count_text
    ...
    def test_estimate_tokens_fallback_without_tiktoken(self):
        ...
        with patch("deepseek_toolkit.token_counter._HAS_TIKTOKEN", False):
            from deepseek_toolkit.token_counter import count_text
            result = count_text("hello world")
