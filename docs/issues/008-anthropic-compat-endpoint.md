...
1. 新建 `deepseek_toolkit/adapters/anthropic_compat.py`
...
- 参考现有适配器：[src/deepseek_toolkit/adapters/openai_compatible.py](../../src/deepseek_toolkit/adapters/openai_compatible.py)
