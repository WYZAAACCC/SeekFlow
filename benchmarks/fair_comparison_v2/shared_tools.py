...
TASKS = {
    ...
    "strategic_conflict": _REASONING_RULES + "\n\n" + _CONFLICT_TASK,
    "intelligence_synthesis": _REASONING_RULES + "\n\n" + _INTELLIGENCE_TASK,
    "compliance_gray_zone": _REASONING_RULES + "\n\n" + _COMPLIANCE_TASK,
}
...
SCENARIO_META = {
    ...
    "strategic_conflict": {"type": "reasoning", "compliance_weight": 0.15},
    "intelligence_synthesis": {"type": "reasoning", "compliance_weight": 0.15},
    "compliance_gray_zone": {"type": "reasoning", "compliance_weight": 0.10},
}
